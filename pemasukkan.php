...
<head>
	...
	<title>Money Amante - Pemasukkan</title>
...
<body>
	<div class="header" style="background-color: #F9F9E0;">
		<h3 class="text-secondary font-weight-bold float-left logo">Data Harian</h3>
	</div>
									...
									<div class="table-responsive">
										<table class="table table-sm table-hover table-striped table-bordered">
											...
											<tr class="show" id="<?= $row['id'] ?>">
													...
													<td data-target="jumlahMasuk"><?= htmlspecialchars(number_format($row['jumlah'] , 0, ',', '.')) ?></td>
													<td>
